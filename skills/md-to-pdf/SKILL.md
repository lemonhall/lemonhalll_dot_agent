...
```bash
node ~/.agents/skills/md-to-pdf/scripts/md-to-pdf.mjs input.md              # Creates input.pdf
node ~/.agents/skills/md-to-pdf/scripts/md-to-pdf.mjs input.md output.pdf   # Custom output name
node ~/.agents/skills/md-to-pdf/scripts/md-to-pdf.mjs input.md --open       # Open after creating
```
...
- **Chrome / Chromium / Edge (Chromium)** — Auto-detected (macOS/Linux/Windows). You can also set `CHROME_PATH`.
